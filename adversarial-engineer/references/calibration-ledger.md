...
|---|---|---|
| Rule 1: Production harm vetoes are absolute | 0 | |
| Rule 2: Genuine options are mandatory | 0 | |
| Rule 3: Fast-path can't silently win | 0 | |
| Rule 4: Engineering must tie to an operational goal | 0 | |

| Agent | False positives | Last prompt tune |
|---|---|---|
| critic | 0 | never |
| ops-advocate | 0 | never |
| reliability-reviewer | 0 | never |
