---
name: doc-adversarial-docs
description: The worker skill for the adversarial-docs loop. Orchestrates a governed review: the docs-adversary agent reviews blind, the constitution gates, and only a human clears a veto.
---

# Adversarial Documentation — Worker Skill

This is the orchestration loop for reviewing docs work. It mirrors the
...
2. **Adversary review.** Spawn the `docs-adversary` agent. Give it the work, the
...
- `doc-accuracy-check`, `doc-completeness-check`, `doc-usability-check`, `doc-consistency-check`, `doc-discoverability-check`.
