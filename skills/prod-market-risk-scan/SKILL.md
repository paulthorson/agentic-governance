---
name: prod-market-risk-scan
description: Stateless skill. Scans for downside if the bet is wrong Returns findings with severity.
---

# Market Risk Scan

Scans for downside if the bet is wrong This is the shared check that any reviewer can run.
