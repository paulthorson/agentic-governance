...
**operator LOCK hybrid.** Cite #43 @ `7e9e0b6` + #37 + #38 + #40.
...
```mermaid
flowchart TD
  E[open /] --> V[Editorial void + Advercase chapters]
  V --> I[3D measured instrument — fluid drift]
  I --> P[White wash on active path]
  P --> X1[hover]
  P --> X2[inspect]
  P --> X3[Get AG]
```
