...
### Removed
- **[redacted] Get AG (operator LOCK public release):** Deleted ``, ``, and empty `docs/legal/`. Settled posture: free/open source Apache-2.0; **no acceptance gate**; LICENSE is the only use governor. **No replacement** Terms/privacy/warranty text. Cross-links in docs/initiatives, `docs/README.md`, dashboard README, and capability report §12.7 updated accordingly.
